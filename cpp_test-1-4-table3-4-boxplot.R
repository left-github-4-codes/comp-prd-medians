...
print(list("t1_lstReg, t1_RD, t1_PRD1, t1_PRD2, t_PRD3", 
           apply(cbind(t_ltsReg, t_RD, t_PRD1,  t_PRD2, t_PRD3),2,mean)))
print(list("EMSE_ltsREg, EMSE_RD, EMSE_PRD1,  EMSE_PRD2, EMSE_PRD3", 
           c(EMSE_ltsREg, EMSE_RD, EMSE_PRD1, EMSE_PRD2, EMSE_PRD3)))

#postscript(file="boxplot-p3.eps")
boxplot(cbind(t_PRD1,t_PRD2, t_RD), names=c("Z19", "Z20","RD"), 
        main="time consumed (seconds) for 1000 samples", 
        xlab="p=3", col=c("blue", "green", "purple"))
#dev.off()
#sq-ltsReg=(beta_ltsReg-beta)*(beta_ltsReg-beta)
...
boxplot(cbind(sq_PRD1,sq_PRD2, sq_RD), names=c("Z19", "Z20","RD"), 
