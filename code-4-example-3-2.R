# adopted from RDREF of codes-4-example-4-2-1.R on 9/22/19 
# for the 1st round revision for csda
#
...
par(mfrow=c(1,2))
plot(m1,xlim=c(-5,15),ylim=c(-5,15), xlab="x-axis",ylab="y-axis",main="uncontaminated")
#plot(m2)
...
legend(-5, 15, legend=c("LS", expression("T*"["RD"]),expression("T*"["PRD"],"ltsReg")),
...
plot(contami_M,xlim=c(-5,15),ylim=c(-5,15), xlab="x-axis",ylab="y-axis",main="contaminated")
fit1<-lm(m3[,2]~m3[,1])
