...
beta_ltsReg=beta_RD=beta_PRD1=beta_PRD2=matrix(0,RepN, ncol=p)
t_ltsReg=t_PRD1=t_PRD2=t_RD=0;
...
print(list("t1_lstReg, t1_RD, t1_PRD1, t1_PRD2", 
           c(t_ltsReg, t_RD, t_PRD1,  t_PRD2)/RepN))
print(list("EMSE_ltsREg, EMSE_RD, EMSE_PRD1,  EMSE_PRD2", 
           c(EMSE_ltsREg, EMSE_RD, EMSE_PRD1, EMSE_PRD2)))
